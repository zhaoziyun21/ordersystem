	...
	<body>
	  ...
	  <tr>
	    <td height="200" align="center" valign="top" background="<%=basePath%>/images/error_bg.jpg">
	        ...
	        <tr>
	          <td width="34%" align="right"><img src="<%=basePath%>/images/err.gif" width="128" height="128"></td>
	          <td width="66%" valign="bottom" align="center">
		        ...
		        <a href="#" onclick="javascript:document.location.href='<%=basePath%>/indexBaseLogin.do';">重 新 登 录</a> 
	  ...
	  <tr>
    	<td><img src="<%=basePath%>/image/err.gif" width="510" height="32" /></td>
      </tr>
	</table>
	</body>
</html>