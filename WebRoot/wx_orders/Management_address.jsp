	...
	<body>
		...
		<script>
			$(function() {
				...
				//返回上一层
				$(".back").click(function(){
					window.location.href="${root}wechat/goSumWeChat.do?flag=0&orderInfo="+orderInfoNew+"&vistorName="+vistorNameNew+"&type="+typeNew+"&leadId="+leadIdNew+"&infos="+infosNew+"&orderType="+orderTypeNew+"&foodBusiness="+foodBusinessNew+"&checkedBusiness="+checkedBusiness;
					//window.history.back();
				});
				//设置默认地址
				...
				$("#list").find("li .li_box").click(function(){
					...
					window.location.href="${root}wechat/goSumWeChat.do?flag=0&orderInfo="+orderInfoNew+"&vistorName="+vistorNameNew+"&checkedAddress="+checkedAddress+"&type="+typeNew+"&leadId="+leadIdNew+"&infos="+infosNew+"&orderType="+orderTypeNew+"&foodBusiness="+foodBusinessNew+"&checkedBusiness="+checkedBusiness;
				})
			})
		</script>		
	</body>
