...
<style>
	...
	function q_my_order(id,num){
		$.MsgBox.Confirm("取消订餐", "是否取消订单",function(){
			...
			$.ajax({
			    url:"${root}wechat/deleteLiveOrderWeChat.do",    //请求的url地址
 	...
 	<div>
         <div class="header">
           	<span>现场订单</span>
           		...
           		<ul>
           			<li onclick="window.location='${root}wechat/toMyOrderWeChat.do'"><span class="choose" >正常订单 </span><div ></div></li>
           			<li onclick="window.location='${root}wechat/toMyReserveOrderWeChat.do'"><span>预约订单</span><div ></div></li>
           			<li onclick="window.location='${root}wechat/toMyLiveOrderWeChat.do'" style="border: 1px solid #f1f1f1;"><span>现场订单</span><div class="choosed"></div></li>
