$(function() {
    ...
    $(".msg-3").click(function(){
		...
		$("#append ul").each(function(i,e){
			var s=$(".object-middle select").val()+$(that).parents(".meal").prev().prev().html();
		...
		if(flag){
			...
			var string="";
			var time=$(".object-middle select").val()+$(that).parents(".meal").prev().prev().html();
			...
			$("#append").append(li);
			$("#"+li.id).append(append);
			var string="",time=$(".object-middle select").val()+$(that).parents(".meal").prev().prev().html();
