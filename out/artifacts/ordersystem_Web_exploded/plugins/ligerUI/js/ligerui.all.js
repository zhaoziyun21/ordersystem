...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            g.grid = $(g.element);
            var gridhtmlarr = [];
            gridhtmlarr.push('        <div class="table_box">');
            gridhtmlarr.push('          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_content"><tbody>');
            gridhtmlarr.push('            <tr class="table_tr">');
            gridhtmlarr.push('            </tr>');
            gridhtmlarr.push('          </tbody></table>');
            gridhtmlarr.push('        </div>');
            gridhtmlarr.push('        <div class="page"></div>');
            gridhtmlarr.push('        <div class="grid-loading"></div>');
