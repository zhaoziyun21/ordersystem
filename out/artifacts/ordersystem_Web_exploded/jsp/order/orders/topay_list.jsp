...
<script>
		...
		function initGrids(){
			...
			url:'${root}onlinePay/getLedgerListOnlinePay.do',
			parms:[{name:"startTime",value:startTime},{name:"endTime",value:endTime},{name:"dep_id",value:dep_id}],
			pageSize:10,
			columns: [
				  ...
				  { display: '总金额', name: 'numMoney', width: '20%' ,
					  totalSummary:
	                    {
	                        type: 'sum',
