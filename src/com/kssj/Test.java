...
public class Test {
	...
	//测试数据源切换
	public static void  jdbctest() throws IOException{
		...
		try {
			...
			XRoleDao dao = (XRoleDao) context.getBean("xRoleDao");
			String sql = "select top 10 * from dbo.HrmCompany";
...
//				XUserSDao deptSumDao = (XDeptSumDao) context.getBean("xDeptSumDao");
